...
public class BasicExemple {
    ...
    public static void test() throws IOException, InterruptedException {
        ...
        final String filenameTrain = new ClassPathResource("depenses2017.data").getFile().getPath();
        final String filenameTest = new ClassPathResource("depenses2017.test").getFile().getPath();
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .layer(1, new OutputLayer.Builder(LossFunctions.LossFunction.XENT).activation(Activation.SIGMOID).nIn(numHiddenNodes).nOut(numClasses).build())
                .build();
